...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._sellOrderValidationAndApprovals = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var wyAssets, schemaNames, sellValid;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        // const tokenAddress = order.paymentToken;
                        _c.sent();
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([
                                order.exchange,
                                order.maker,
                                order.taker,
                                order.feeRecipient,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
